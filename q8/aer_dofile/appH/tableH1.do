/******************************************************
TABLE H1: DD Estimates by Specification, ALL CENTERS
******************************************************/
clear
clear matrix
set mat 5000
...
pause on
capture log close
log using "$output/log_tableH1", replace text	
...
local X4 "_Iyear* _IyeaXDu* _IyeaXst* D_* R_* H_* _DD* [aw=dflpopwgt2]"								
...
foreach i of numlist 1 2 3 4{		
	...
	*OUTREG RESULTS
	outreg2 using "$output/tableH1.xls", `r' keep(_DDdid2_2 _DDdid2_4 _DDdid2_5 ) noparen noaster ctitle("AMR: `e(cmdline)'") 
	local r append
}
...
local X4 "_Iyear* _IyeaXDu* _IyeaXst* D_* R_* H_* _DD* [aw=dflpopwgt2_eld]"								
...
foreach i of numlist 1 2 3 4{		
	...
	*OUTREG RESULTS
	outreg2 using "$output/tableH1.xls", `r' keep(_DDdid2_2 _DDdid2_4 _DDdid2_5 ) noparen noaster ctitle("AMR 50+: `e(cmdline)'") 
	local r append
}
